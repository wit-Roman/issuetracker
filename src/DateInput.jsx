...
export default class DateInput extends React.Component {
	...
	onBlur(e) {
		...
		if (valid !== this.state.valid && this.props.onValidityChange) this.props.onValidityChange(e, valid);
	...
	render() {
		...
		return ( 
			<input type="text" name={this.props.name} className={className} value={value} onFocus={this.onFocus} onBlur={this.onBlur} onChange={this.onChange} />
		);
	}
}
